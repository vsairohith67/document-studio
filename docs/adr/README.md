...
| [ADR-019](ADR-019-hidden-webview2-text-pdf-renderer.md) | Use typed Windows/WebView2 projections for a hidden intercepted TXT-to-PDF renderer | Accepted for G04E1 implementation |
