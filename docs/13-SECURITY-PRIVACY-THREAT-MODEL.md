...
- **Unicode abuse:** strict UTF-8, BOM/control/bidi/noncharacter admission, code-point range plus exact cmap membership and bounded combining/joiner shaping reject unsupported or pathological text before renderer creation.
